class sauria_df_controller_cfg_reg_18 extends uvm_reg;

    `uvm_object_utils(sauria_df_controller_cfg_reg_18)

    uvm_reg_field start_srama_addr;

    function new(string name="sauria_df_controller_cfg_reg_18");
        super.new(name, SAURIA_REG_SIZE, REG_COVERAGE);
    endfunction

    function void build_fields();
        start_srama_addr = uvm_reg_field::type_id::create("sauria_df_start_srama_addr");
    endfunction
    ...
    function void configure(uvm_reg_block blk_parent, uvm_reg_file regfile_parent=null, string hdl_path="");
        ...
        start_srama_addr.configure(.parent(this),
                                .size(DF_START_SRAMA_ADDR_SIZE),
                                .lsb_pos(DF_START_SRAMA_ADDR_LSB),
