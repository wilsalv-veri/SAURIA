class sauria_dma_controller_cfg_reg_11 extends uvm_reg;

    `uvm_object_utils(sauria_dma_controller_cfg_reg_11)

    uvm_reg_field dma_ifmaps_c_lim;

    function new(string name="sauria_dma_controller_cfg_reg_11");
        super.new(name, SAURIA_REG_SIZE, REG_COVERAGE);
    endfunction

    function void build_fields();
        dma_ifmaps_c_lim = uvm_reg_field::type_id::create("sauria_dma_ifmaps_c_lim");
    endfunction
