class sauria_dma_controller_cfg_reg_0 extends uvm_reg;

    `uvm_object_utils(sauria_dma_controller_cfg_reg_0)

    uvm_reg_field dma_tile_x_lim;
    uvm_reg_field dma_tile_y_lim;

    function new(string name="sauria_dma_controller_cfg_reg_0");
        super.new(name, SAURIA_REG_SIZE, REG_COVERAGE);
    endfunction

    function void build_fields();
        dma_tile_x_lim = uvm_reg_field::type_id::create("sauria_dma_tile_x_lim");
        dma_tile_y_lim = uvm_reg_field::type_id::create("sauria_dma_tile_y_lim");
    endfunction
