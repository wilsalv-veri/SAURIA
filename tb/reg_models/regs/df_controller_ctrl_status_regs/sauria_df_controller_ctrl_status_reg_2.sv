...
class sauria_df_controller_ctrl_status_reg_2 extends uvm_reg;
    ...
    function void build_fields();
        done_interrupt_en = uvm_reg_field::type_id::create("ctrl_status_done_interrupt_en");
    endfunction
    ...
    function void configure(uvm_reg_block blk_parent, uvm_reg_file regfile_parent=null, string hdl_path="");
        ...
        // Interrupt enable for SAURIA's done signal
        done_interrupt_en.configure(.parent(this),
                        .size(CTRL_STATUS_DONE_INT_EN_SIZE),
                        .lsb_pos(CTRL_STATUS_DONE_INT_EN_LSB),
